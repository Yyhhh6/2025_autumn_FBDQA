...
tmp5：不早停，8000步，不加量价特征

tmp6：不早停，8000步，加上所有量价特征

tmp7：...去掉下面一行的特征，只保留上面一行

tmp8：...去掉上面一行的特征，只保留下面一行

tmp9：去掉了两个量价特征，然后加上了amount的几个特征，不早停

tmp10：早停为150

tmp11：penalty = 300，不早停

tmp12：12000步，penalty = 100，不早停
