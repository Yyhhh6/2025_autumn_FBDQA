...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_boost_round", type=int, default=3000, help="Number of boosting rounds")
    ...
    if args.sym != "all":
        args.file_dir = f"./data/data_{args.sym}"
        args.save_path = f"./models/model_label20_{args.sym}/"
    ...
    for N in N_list:
        # 划分训练集、验证集、测试集
        train_files, val_files, test_files = split_csv_files(data_dir=args.file_dir + "_train", train_ratio=TRAIN_RATIO, val_ratio=VAL_RATIO, test_ratio=1-TRAIN_RATIO-VAL_RATIO, seed=SEED)
