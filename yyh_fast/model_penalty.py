...
# 定义一个包装函数，把权重固定
def make_weighted_softmax_obj(profit_train, weight1, weight2, weight3, penalty_scale=5.0):
    def weighted_softmax_obj(preds, dtrain):
        return pnl_weighted_softmax_obj(preds, dtrain, profit_train=profit_train, weight1=weight1, weight2=weight2, weight3=weight3, penalty_scale=penalty_scale)
...
class XGBModel:
    ...
    def train(
        ...
        sym: str = "all",
        train_profits: Optional[np.ndarray] = None,
        ...
        self.model = xgb.train(
            ...
            evals=evals,
            obj=make_weighted_softmax_obj(profit_train=train_profits, weight1=weight1, weight2=weight2, weight3=weight3, penalty_scale=penalty_scale), 
