...
if __name__ == "__main__":
    ...
    parser.add_argument("--early_stopping_rounds", type=int, default=20000, help="Number of early stopping rounds")
    ...
    parser.add_argument("--save_path", type=str, default="./models_tmp12/", help="save_path")
