...
# 1. 读取 CSV
file_paths = ["data/data_sym0/snapshot_sym0_date1_am.csv", "data/data_sym0/snapshot_sym0_date1_am.csv", "data/data_sym0/snapshot_sym0_date1_am.csv", "data/data_sym0/snapshot_sym0_date1_am.csv"]
...
# 3. 绘图功能
def plot_features(df, features_to_plot, save_path="Features/figures/features_plot.png"):
